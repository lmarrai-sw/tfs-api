import { AcbsGetPartyBySearchTextResponseElement } from '@ukef/modules/party/dto/acbs-get-party-by-search-text-response-element.dto';
import { GetPartyBySearchTextResponseElement } from '@ukef/modules/party/dto/get-party-by-search-text-response-element.dto';
...
interface GenerateResult {
  partiesInAcbs: AcbsGetPartyBySearchTextResponseElement[];
  parties: Party[];
  partiesFromApi: GetPartyBySearchTextResponseElement[];
}
